...
const extractedGPSData = [
  { fileName: 'ABOW5086.JPG', address: 'Barracuda Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.389451, longitude: 27.807816, dateTime: '07/23/2025 10:57 AM GMT+02:00' },
  { fileName: 'AEJD0192.JPG', address: '3rd Avenue, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.387176, longitude: 27.806611, dateTime: '07/23/2025 10:26 AM GMT+02:00' },
  { fileName: 'ANGT3574.JPG', address: '2nd Avenue, Lawley Estate, Lawley, Gauteng 1830, South Africa', latitude: -26.374962, longitude: 27.811221, dateTime: '07/23/2025 02:03 PM GMT+02:00' },
  { fileName: 'ARGS9536.JPG', address: '2nd Avenue, Lawley Extento, Lawley, Gauteng 1830, South Africa', latitude: -26.373870, longitude: 27.810132, dateTime: '07/23/2025 02:05 PM GMT+02:00' },
  { fileName: 'ARZV1695.JPG', address: 'Lebone Street, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.382413, longitude: 27.805773, dateTime: '07/24/2025 03:35 PM GMT+02:00' },
  { fileName: 'AVQE2541.JPG', address: 'Mackerel Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.391663, longitude: 27.811781, dateTime: '07/23/2025 11:11 AM GMT+02:00' },
  { fileName: 'AXWD8963.JPG', address: 'Rebose Street, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.379983, longitude: 27.805586, dateTime: '07/24/2025 03:31 PM GMT+02:00' },
  { fileName: 'BIZJ8490.JPG', address: 'Lawley Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.381851, longitude: 27.812077, dateTime: '07/24/2025 03:22 PM GMT+02:00' },
  { fileName: 'BMCZ3397.JPG', address: '3rd Avenue, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.386286, longitude: 27.806431, dateTime: '07/23/2025 10:25 AM GMT+02:00' },
  { fileName: 'BMES8191.JPG', address: 'Barracuda Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.382283, longitude: 27.809114, dateTime: '07/24/2025 03:19 PM GMT+02:00' },
  { fileName: 'CKCL1172.JPG', address: 'Ramalepe Street, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.384188, longitude: 27.806924, dateTime: '07/24/2025 03:11 PM GMT+02:00' },
  { fileName: 'DMWX1009.JPG', address: 'Barracuda Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.390316, longitude: 27.810644, dateTime: '07/23/2025 11:02 AM GMT+02:00' },
  { fileName: 'GBBN9148.JPG', address: 'Siyabonga Street, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.378948, longitude: 27.809967, dateTime: '07/23/2025 01:56 PM GMT+02:00' },
  { fileName: 'HRHV1719.JPG', address: '5th Avenue, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.382739, longitude: 27.805834, dateTime: '07/24/2025 03:35 PM GMT+02:00' },
  { fileName: 'LEFU9103.JPG', address: 'Piranha Crescent, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.396490, longitude: 27.813118, dateTime: '07/23/2025 11:22 AM GMT+02:00' },
  { fileName: 'PXFC6466.JPG', address: '2nd Avenue, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.384564, longitude: 27.806597, dateTime: '07/24/2025 03:04 PM GMT+02:00' },
  { fileName: 'RQBM3981.JPG', address: '13 Enoch Street, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.380007, longitude: 27.808841, dateTime: '07/23/2025 02:15 PM GMT+02:00' },
  { fileName: 'UUZQ0214.JPG', address: 'Lawley Road, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.382613, longitude: 27.807202, dateTime: '07/24/2025 03:14 PM GMT+02:00' },
  { fileName: 'XHPT1307.JPG', address: '2nd Avenue, Elandsfontein, Lawley, Gauteng 1830, South Africa', latitude: -26.383169, longitude: 27.812837, dateTime: '07/23/2025 10:13 AM GMT+02:00' }
];
...
// Status data from processing
const fileStatuses = {
  'ABKU4865.JPG': 'CORRUPTED',
  'AFKK3290.JPG': 'EMPTY',
  'AGJO0968.JPG': 'EMPTY',
  'ALDT8478.JPG': 'EMPTY',
  'AQXY9444.JPG': 'CORRUPTED',
  'ARDJ2862.JPG': 'EMPTY',
  'ASFR5899.JPG': 'CORRUPTED',
  'BAHM3423.JPG': 'EMPTY',
  'BBFL7303.JPG': 'EMPTY',
  'BBNO8820.JPG': 'CORRUPTED'
  // ... add more as discovered
};

async function createComprehensiveReport() {
  console.log('📍 CREATING COMPREHENSIVE GPS EXTRACTION REPORT\n');
  ...
  try {
    ...
    extractedGPSData.forEach(d => extractedMap.set(d.fileName, d));
    ...
    // Create CSV
    const csvPath = path.join(REPORT_DIR, 'ettiene-comprehensive-gps-report.csv');
    ...
    gpsSheet.columns = allDataSheet.columns;
    ...
    summarySheet.addRows([
      ...
      { info: '', details: '' },
      { info: 'STATUS BREAKDOWN', details: '' },
      { info: 'GPS Data Extracted', details: `${extracted} (${(extracted/allFileNames.length*100).toFixed(1)}%)` },
      ...
      { info: 'Streets Covered', details: Object.keys(extractedGPSData.reduce((acc, d) => { acc[d.address.split(',')[0]] = true; return acc; }, {})).length },
      { info: '', details: '' },
      { info: 'TECHNICAL DETAILS', details: '' },
      { info: 'Upload Date', details: '25 July 2025' },
      { info: 'Uploaded By', details: 'ettienejvr@gmail.com' },
      { info: 'Processed By', details: 'louisrdup@gmail.com' }
    ]);
    
    summarySheet.getRow(1).font = { bold: true };
    
    // Save Excel
    const excelPath = path.join(REPORT_DIR, 'ettiene-comprehensive-gps-report.xlsx');
    await workbook.xlsx.writeFile(excelPath);
    console.log(`✅ Excel created: ${excelPath}`);
    
    console.log('\n' + '='.repeat(60));
    console.log('📊 COMPREHENSIVE GPS EXTRACTION REPORT');
    console.log('='.repeat(60));
    console.log(`✅ GPS Extracted: ${extracted} locations`);
    console.log(`❌ Corrupted: ${corrupted} files`);
    console.log(`⚠️  Empty: ${empty} files`);
    console.log(`⏳ Pending: ${pending} files`);
    console.log(`📷 Total: ${allFileNames.length} images`);
    console.log('\n✅ Reports ready:');
