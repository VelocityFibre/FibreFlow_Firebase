...
async function generateFullReport(importId, fileName) {
  ...
  try {
    ...
    const report = `# JUNE 3RD 2025 - COMPLETE IMPORT REPORT
...
`;
    ...
    // Save report
    const reportPath = path.join('OneMap/reports', `JUNE_03_COMPLETE_REPORT_${importId}.md`);
...
// Run the report
generateFullReport('IMP_2025-07-22_1753178091377', 'Lawley June Week 1 03062025.csv');