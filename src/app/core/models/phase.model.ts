...
export const DEFAULT_PHASES: Omit<PhaseTemplate, 'id'>[] = [
  ...
  },
  {
    ...
    isDefault: true,
    defaultDependencies: [
      { phaseId: 'planning', type: DependencyType.FINISH_TO_START }
    ]
  },
  {
    ...
    isDefault: true,
    defaultDependencies: [
      { phaseId: 'initiate-project', type: DependencyType.FINISH_TO_START }
    ]
  },
  {
    name: 'Handover',
    ...
    isDefault: true,
    defaultDependencies: [
      { phaseId: 'work-in-progress', type: DependencyType.FINISH_TO_START }
    ]
  },
  {
    ...
    isDefault: true,
    defaultDependencies: [
      { phaseId: 'handover', type: DependencyType.FINISH_TO_START }
    ]
  },
  {
    ...
    isDefault: true,
    defaultDependencies: [
      { phaseId: 'handover-complete', type: DependencyType.FINISH_TO_START }
    ]
  }
];