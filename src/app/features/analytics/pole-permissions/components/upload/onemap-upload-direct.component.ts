          ...
          @if (files().length > 0) {
            <div class="file-list">
              ...
              <div class="actions">
                ...
                <button mat-button (click)="clearFiles()" [disabled]="isUploading()">Clear</button>
              </div>
            </div>
          }
        </mat-card-content>
      ...
      <mat-card class="instructions-card">
        ...
        <mat-card-content>
          <p class="info-message">
            ...
            This upload method sends CSV data directly to the database, bypassing Firebase Storage
            permissions.
          </p>
          ...
          <div class="info-box">
            ...
            <p>
              Your data is secure. Files are processed in your browser and sent directly to the VF
              OneMap database.
            </p>
          </div>
        </mat-card-content>
