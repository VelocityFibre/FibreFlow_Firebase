            ...
            <div class="filters-grid">
              ...
              <mat-form-field>
                ...
                <input
                  matInput
                  [(ngModel)]="searchText"
                  placeholder="Search entity names, actions..."
                />
              </mat-form-field>
              ...
              >
                ...
                <div class="changes-section" *ngIf="log.changes && log.changes.length > 0">
                  ...
                  <div class="field-changes">
                    <div class="field-change" *ngFor="let change of log.changes">
                      <span class="field-name">{{ change.field }}:</span>
                      <span class="value-change">
                        <span class="old-value">{{
                          change.displayOldValue || change.oldValue || 'null'
                        }}</span>
                        <mat-icon class="arrow-icon">arrow_forward</mat-icon>
                        <span class="new-value">{{
                          change.displayNewValue || change.newValue || 'null'
                        }}</span>
                      </span>
                    </div>
                  </div>
...
export class AuditTrailPageComponent implements OnInit {
  ...
  async loadAuditLogs() {
    ...
    try {
      ...
      const result = await this.auditService.getAuditLogs(filters, 50, this.lastDocument);
