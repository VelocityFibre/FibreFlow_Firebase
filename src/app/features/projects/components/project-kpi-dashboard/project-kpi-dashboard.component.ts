          ...
          <div class="summary-card" *ngFor="let kpi of kpiStatuses$ | async">
            ...
            <div class="summary-progress">
              ...
              <div class="progress-status">
                ...
                <span class="status" [class.on-track]="kpi.isOnTrack" [class.behind]="!kpi.isOnTrack">
...
export class ProjectKpiDashboardComponent implements OnInit {
    ...
    return [
      {
        ...
        percentage: this.calculatePercentage(latestKPIs.permissionsTotal, targets.polePermissions.totalTarget),
      ...
      },
      {
        ...
        percentage: this.calculatePercentage(latestKPIs.homeSignupsTotal, targets.homeSignups.totalTarget),
        isOnTrack: true,
        daysAhead: 0,
        icon: 'home',
        color: '#10B981'
      },
      {
        ...
        percentage: this.calculatePercentage(latestKPIs.polesPlantedTotal, targets.polesPlanted.totalTarget),
        isOnTrack: true,
        daysAhead: 0,
        icon: 'vertical_split',
        color: '#F59E0B'
      },
      {
        ...
        percentage: this.calculatePercentage(this.getTotalStringing(latestKPIs), targets.fibreStringing.totalTarget),
        isOnTrack: true,
        daysAhead: 0,
        icon: 'cable',
        color: '#8B5CF6'
      },
      {
        ...
        percentage: this.calculatePercentage(latestKPIs.trenchingTotal, targets.trenchingMeters.totalTarget),
        isOnTrack: true,
        daysAhead: 0,
        icon: 'construction',
        color: '#EF4444'
  ...
  getTotalStringing(kpis: DailyKPIs): number {
    return (kpis.stringing24Total || 0) + 
