    ...
    <mat-dialog-content>
      <div class="import-wizard">
        ...
        <div class="step-progress">
          <div class="progress-item" [class.active]="currentStep >= 1" [class.completed]="currentStep > 1">
            <div class="progress-dot">1</div>
            <span>Project</span>
          </div>
          <div class="progress-line" [class.active]="currentStep > 1"></div>
          <div class="progress-item" [class.active]="currentStep >= 2" [class.completed]="currentStep > 2">
            <div class="progress-dot">2</div>
            <span>File</span>
          </div>
          <div class="progress-line" [class.active]="currentStep > 2"></div>
          <div class="progress-item" [class.active]="currentStep >= 3" [class.completed]="currentStep > 3">
...
export class BOQImportExcelDialogComponent implements OnInit {
  ...
  canProceed(): boolean {
    switch (this.currentStep) {
      case 1: return !!this.selectedProjectId;
      case 2: return !!this.selectedFile;
      case 3: return !!this.selectedSheet;
  ...
  async loadSheets() {
    ...
    try {
      ...
      if (this.availableSheets.length > 0) {
        const masterSheet = this.availableSheets.find(s => 
