...
export class StockService {
  ...
  private stockItemsCollection = collection(this.firestore, 'stockItems') as CollectionReference<StockItem>;
  private stockMovementsCollection = collection(this.firestore, 'stockMovements') as CollectionReference<StockMovement>;
  private stockAllocationsCollection = collection(this.firestore, 'stockAllocations') as CollectionReference<StockAllocation>;
